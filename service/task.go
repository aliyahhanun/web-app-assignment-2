...
func (s *taskService) Update(task *model.Task) error {
	return s.taskRepository.Update(task) // TODO: replace this
}

func (s *taskService) Delete(id int) error {
	return s.taskRepository.Delete(id) // TODO: replace this
}
...
func (s *taskService) GetList() ([]model.Task, error) {
	return s.taskRepository.GetList() // TODO: replace this
}

func (s *taskService) GetTaskCategory(id int) ([]model.TaskCategory, error) {
	return s.taskRepository.GetTaskCategory(id) // TODO: replace this
}
